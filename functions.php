<?php
/**
 * SPA starter theme functions and definitions
 *
...
function spa_setup() {
	/*
		...
		* If you're building a theme based on SPA starter theme, use a find and replace
...
function spa_scripts() {
	wp_enqueue_style( 'spa-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'spa-style', 'rtl', 'replace' );

	wp_enqueue_script( 'spa-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
